...
class EmployesControllerTest < ActionController::TestCase
  ...
  test "should create employe" do
    assert_difference('Employe.count') do
      post :create, employe: { age: @employe.age, date_of_birth: @employe.date_of_birth, dep_id: @employe.dep_id, joining_date: @employe.joining_date, name: @employe.name }
    end
  ...
  test "should update employe" do
    put :update, id: @employe, employe: { age: @employe.age, date_of_birth: @employe.date_of_birth, dep_id: @employe.dep_id, joining_date: @employe.joining_date, name: @employe.name }
    assert_redirected_to employe_path(assigns(:employe))
  end
